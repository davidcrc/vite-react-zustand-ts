...
export const PandaBears = () => {
  ...
  const { pandaBears, increasePandaBears } = useBearStore(
    useShallow((state) => ({
      pandaBears: state.pandaBears,
      increasePandaBears: state.increasePandaBears,
    }))
  );
...
export const BearDisplay = () => {
  ...
  const bears = useBearStore(useShallow((state) => state.bears)); //useShallow, se usa para que el estado bears q estamos tomando aqui no rerenderize , si no ha cambiado
